...
internal sealed class CsFileBuilder {
    ...
    public CsFileBuilder AddUsing(string usingStatement) {
        _indentedTextWriter.WriteLine($"using {usingStatement};");
        return this;
    }

    public CsFileBuilder AddStaticUsing(string usingStatement) {
        _indentedTextWriter.WriteLine($"using static {usingStatement};");
        return this;
    }

    public CsFileBuilder AddNamespace(string? namespaceName, bool condition = true) {
    ...
    public CsFileBuilder AddNamespace(INamespaceSymbol namespaceSymbol) {
        return namespaceSymbol.IsGlobalNamespace
            ? this
            : AddNamespace(namespaceSymbol.ToDisplayString());
    }

    public CsFileBuilder AddFileScopedNamespace(INamespaceSymbol namespaceSymbol, bool condition = true) {
    ...
    public CsFileBuilder AddStatementAndStartBlock(string line) {
    ...
    public CsFileBuilder AddStatements(params ReadOnlySpan<string?> lines) {
    ...
    public CsFileBuilder AddStatementsIf(bool condition, params ReadOnlySpan<string> lines) {
    ...
    public CsFileBuilder AddEmptyLine(bool condition = true) {
        if (condition is false) {
            return this;
        }
    ...
    public CsFileBuilder AddCommentLine(string line) {
        _indentedTextWriter.WriteLine($"//{line}");
        return this;
    }

    public CsFileBuilder EndBlock() {
        GoOneLevelOutside();
        return this;
    }

    public CsFileBuilder EndNamespace() {
    ...
    public CsFileBuilder AddIfBlock(string condition, params ReadOnlySpan<string> lines) {
    ...
    public CsFileBuilder AddAutoGeneratedHeader(string by) {
        AddStatements("//------------------------------------------------------------------------------",
                        "// <auto-generated>",
    ...
    public CsFileBuilder AddPreprocessorDirectives() {
    ...
    public CsFileBuilder AddGeneratedAttributes(
    ...
    public CsFileBuilder AddXmlCommentLines(params ReadOnlySpan<string> lines) {
        foreach (string line in lines) {
            _indentedTextWriter.WriteLine($"/// {line}");
        }
        return this;
    ...
    public CsFileBuilder AddText(string text) {
        _indentedTextWriter.Write(text);

        return this;
    }

    public CsFileBuilder AddPartialType(ITypeSymbol typeSymbol) {
    ...
    public CsFileBuilder EndPartialType(ITypeSymbol typeSymbol) {
        var parent = typeSymbol.ContainingSymbol as ITypeSymbol;
        while (parent is not null) {
            this.EndBlock();
            parent = parent.ContainingSymbol as ITypeSymbol;
